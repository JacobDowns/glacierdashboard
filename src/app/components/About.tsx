                            ...
                            <Table sx={{ minWidth: 650 }} aria-label="simple table">
                                ...
                                <TableBody>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell>{
                                        `Displays basic information and statistics for the currently selected glacier.`}
                                        </TableCell>
                                    </TableRow>
                                    <TableRow>
            ...
            <Card elevation={3} sx={{ padding: 2 }}>
                ...
                <Accordion>
                    ...
                    <AccordionDetails>
                        ...
                        To select a dataset, select any row in the datasets table.`}
                    </AccordionDetails>
                </Accordion>
                            ...
                            <Table sx={{ minWidth: 650 }}>
                                ...
                                <TableBody>
                                    <TableRow>
                                        ...
                                        <TableCell>Total area of RGI glaciers in a subregion.</TableCell>
                                    </TableRow>
                                    <TableRow>
